...
public class DoubleXLabelAxisRenderer extends XAxisRenderer {
    ...
    public DoubleXLabelAxisRenderer(String[] Values, ViewPortHandler viewPortHandler, XAxis xAxis, Transformer transformer, IAxisValueFormatter topValueFormatter) {
